...
TARGET_SERVER="f29a93870aaa431d7c4794f2952e84f473d18cdc"
TARGET_MEMORIA="61c4860924bfdaaf932833d0e95a09ec016538ae"
TARGET_BDR="5b41487031f1f3d0a3daeaf03f5d7cb6bceebfe1"
BACKUP_ROOT="${MEMORIA_BACKUP_ROOT:-$HOME/memoria.ia.backups}"
STAMP="$(date +%Y%m%d-%H%M%S)"
BACKUP="$BACKUP_ROOT/v2-server-rc1-freeze-$STAMP"
...
echo "==============================================="
echo " Memoria.ia Server - V2 Server RC1 Freeze Test"
...
echo
echo "==============================================="
echo " V2 SERVER RC1 FREEZE TEST ATIVO"
echo "==============================================="
