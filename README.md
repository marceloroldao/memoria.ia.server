...
A versão instalável atual é `v0.1.0-alpha.9`.
...
Consulte o [guia completo de instalação](docs/INSTALLATION.md) e as [notas da versão](RELEASE_NOTES_v0.1.0-alpha.9.md). Use HTTPS antes de expor o painel publicamente.
